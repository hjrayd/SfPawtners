...
INSERT INTO `cat` (`id`, `user_id`, `name`, `gender`, `date_birth`, `description`, `city`, `litter`, `date_profile`, `vaccinated`) VALUES
	...
	(61, 57, 'srser', 'Mâle', '2023-02-09', 'df', '67480', 0, '2025-01-24 12:37:00', 0);
...
INSERT INTO `image` (`id`, `cat_id`, `image_link`, `image_alt`) VALUES
	...
	(74, 61, '/uploads/pictures/Capture-d-ecran-21-6793896f35440.png', 'srser');
...
-- Listage des données de la table pawtners.topic : ~6 rows (environ)
DELETE FROM `topic`;
INSERT INTO `topic` (`id`, `user_id`, `category_id`, `title`, `locked`, `topic_date`) VALUES
	(23, 57, 26, 'Whiskas est elle une bonne marque de croquettes ?', 0, '2025-01-24 13:17:53'),
	(24, 57, 19, 'Quels vaccins recommandé pour voyager ?', 0, '2025-01-24 13:18:21'),
	(25, 57, 29, 'Marque d\'arbre à chats de bonne qualité', 0, '2025-01-24 13:18:41'),
	(26, 57, 30, 'Adoption d\'un chaton, idées de noms ?', 0, '2025-01-24 13:18:57'),
	(28, 57, 28, 'Comment adopter à la SPA ?', 1, '2025-01-24 13:23:18'),
	(29, 57, 28, 'Refuge sur Strasbourg pour adopter des chats', 0, '2025-01-24 15:06:15');
