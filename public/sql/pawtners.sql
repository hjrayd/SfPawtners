...
-- Listage des données de la table pawtners.category : ~9 rows (environ)
...
-- Listage des données de la table pawtners.message : ~7 rows (environ)
...
INSERT INTO `topic` (`id`, `user_id`, `category_id`, `title`, `locked`, `topic_date`) VALUES
	(22, 57, 31, 'Whiskas est elle une bonne marque de croquettes ?', 0, '2025-01-24 09:01:19');
